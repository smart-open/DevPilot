...
print_credentials() {
    ...
    echo "  使用方式:        docker compose exec claude-litellm claude"
...
echo ""
echo -e "${CYAN}常用命令:${NC}"
echo "  启动 Claude Code:   docker compose exec claude-litellm claude"
...
echo "  1. 启动会话: docker compose exec claude-litellm claude"
