...
| 安装组件 | `@anthropic-ai/claude-code@2.1.220` + devpilot-litellm (LiteLLM 1.82.6) | - |
...
# devpilot-litellm 基础镜像由 python:3.13-slim 提供，无需下载二进制
RUN curl -fsSL \
# pip install 用法见 dockerfiles/litellm/Dockerfile
...
| `AGNES_MODEL_FLASH` | `agnes-2.5-flash` | 默认模型名称 |
...
| `AGNES_MODEL_FLASH` | agnes-ai | `agnes-2.5-flash` | 否 | 默认模型名称 |
