...
4. **资源高效利用**：三容器架构总内存约 2.3GB（redis 512M + openclaw 768M + devpilot-claude-litellm 1024M），在普通开发机上即可运行全部功能。
...
| devpilot-claude-litellm | 512MB | 256MB | 50% | LiteLLM 代理（docker-compose limits 512M / reservations 256M） |
